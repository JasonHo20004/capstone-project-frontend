        ...
        <header className="flex items-center justify-between px-6 py-4 bg-white/80 backdrop-blur-md sticky top-0 z-10 border-b border-slate-200">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:block w-full max-w-md relative">
              ...
              <input
                type="text"
                placeholder="Search for courses and flashcards..."
                className="block w-[320px] lg:w-[380px] pl-10 pr-3 py-2 border-none rounded-lg leading-5 bg-slate-100 text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary sm:text-sm h-10 transition-shadow"
              />
            </div>
          </div>
